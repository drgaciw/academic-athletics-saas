...
export default function DatasetsPage() {
  ...
  const onCreateTestCase = async (data: TestCaseFormData) => {
    try {
      ...
      alert(err instanceof Error ? err.message : 'Invalid JSON in input or expected output');
    }
  };
    ...
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Create and manage test datasets for evaluations</p>
        </div>
        <div className="flex gap-3">
          <Button variant="outline" onClick={importDataset}>
            Import Dataset
          </Button>
          <Button onClick={() => setShowNewDatasetForm(true)}>Create Dataset</Button>
        </div>
      </div>
      ...
      {showNewDatasetForm && (
        <Card className="border-2 border-blue-500">
          ...
          <CardContent>
            <form onSubmit={datasetForm.handleSubmit(onCreateDataset)} className="space-y-4">
              <div>
            ...
            <TableBody>
              {datasets.map((dataset) => (
                <TableRow key={dataset.id}>
                  ...
                  <TableCell className="max-w-md truncate">{dataset.description}</TableCell>
                  <TableCell>
                    <Badge variant="secondary">{dataset.version}</Badge>
                  </TableCell>
                  <TableCell className="text-right">{dataset.testCaseCount}</TableCell>
          ...
          <CardContent>
            {showNewTestCaseForm && (
              <Card className="mb-4 border-2 border-blue-500">
                ...
                <CardContent>
                  <form onSubmit={testCaseForm.handleSubmit(onCreateTestCase)} className="space-y-4">
                    ...
                    <div>
                      <Label htmlFor="tc-expected">Expected Output (JSON)</Label>
                      <Textarea
                        id="tc-expected"
