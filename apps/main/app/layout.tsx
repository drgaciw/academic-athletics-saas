...
export const metadata: Metadata = {
    ...
    description:
          'Academic support and eligibility management for Oral Roberts University Men\'s and Women\'s Soccer student-athletes.',
}
...
export default function RootLayout({
  ...
  return (
        <ClerkProvider {...(clerkProviderProps as any)}>
              <html lang="en">
                      <body
                                  className={`${inter.variable} ${lexend.variable} font-sans antialiased bg-white`}
                                >
                                <a
                                              href="#main-content"
                                              className="absolute left-0 top-0 z-[100] -translate-y-full rounded bg-oru-navy px-4 py-2 text-white transition-transform focus:translate-y-0"
                                            >
                                            Skip to content
                                </a>a>
                      
                        {/* ORU Soccer Navigation */}
                                                          ...
                                                          <div className="flex items-center justify-between h-16">
                                                            {/* Logo + Brand */}
                                                                          <Link href="/" className="flex items-center gap-3 group">
                                                                                            ...
                                                                                            <div className="flex flex-col leading-tight">
                                                                                                                <span className="text-oru-gold font-bold text-sm tracking-wide uppercase">
                                                                                                                                      ORU Soccer
                                                                                                                  </span>span>
                                                            ...
                                                            {/* Nav Links */}
                                                                          <nav className="hidden md:flex items-center gap-8" aria-label="Main navigation">
                                                                                            <Link
                                                                                                                  href="#features"
                                                                                                                  className="text-white/80 hover:text-oru-gold text-sm font-medium transition-colors"
                                                                                                                >
                                                                                                                Features
                                                                                              </Link>Link>
                                                                                            <Link
