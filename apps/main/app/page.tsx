        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40">
          <div className="text-center max-w-4xl mx-auto">
            <h1 className="text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl lg:text-7xl leading-tight">
              Empowering Student-Athletes,<br />
              Simplifying Compliance
            </h1>
            <p className="mt-6 text-lg sm:text-xl text-gray-200 max-w-3xl mx-auto">
              The all-in-one platform to manage academic progress, ensure eligibility,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
              Comprehensive tools for student-athlete academic support, NCAA compliance
              management for student-athletes, coaches, and administrators.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Track grades, attendance, and progress with tools & AI to help students stay on track to support
                student-athletes in their academic journey.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Stay ahead of NCAA and conference requirements with automated eligibility
                checks and compliance alerts.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Connect coaches, students, advisors, and faculty through integrated
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Athletic Director, State University</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Academic Coordinator, Tech College</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Academic Advisor, Metro University</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            ...
            student-athlete support. Take the first step to simplifying athletic academic today.
          </p>
          <Link
            href="/sign-up"
            className="inline-block rounded-md bg-primary px-8 py-4 text-base font-semibold text-white shadow-lg hover:bg-primary/90 transition-colors"
      ...
      <footer className="bg-gray-900 text-gray-300 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div>
              <h3 className="text-white font-bold text-lg mb-4">Athletic Academics Hub</h3>
