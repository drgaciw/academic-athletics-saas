           ...
           describe('runTestCase', () => {
                 it('should execute a test case and return result with metadata', async () => {
                        ...
                        it('should handle errors gracefully', async () => {
                                ...
                                generateObject.mockRejectedValueOnce(new Error('Unknown model provider for: unknown/model'));
                 ...
                 it('should detect OpenAI models', () => {
                        ...
                        it('should handle unknown providers with error in result', async () => {
                                ...
                                generateObject.mockRejectedValueOnce(
                                          new Error('Unknown model provider for: unknown/model')
                                        );
           ...
           describe('retry logic', () => {
                 it('should retry on retryable errors', async () => {
                        ...
                        it('should not retry on non-retryable errors', async () => {
                                const { generateObject } = require('ai');
                                generateObject.mockRejectedValueOnce(
                                          new Error('Unknown model provider for: invalid-model')
                                        );
