-- Add compliance regulation-watch roles and data model.
...
ALTER TABLE "RegulationCheckRun"
  ADD CONSTRAINT "RegulationCheckRun_sourceId_fkey"
  FOREIGN KEY ("sourceId") REFERENCES "RegulationSource"("id")
  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "RegulationDocumentSnapshot"
  ADD CONSTRAINT "RegulationDocumentSnapshot_sourceId_fkey"
  FOREIGN KEY ("sourceId") REFERENCES "RegulationSource"("id")
  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "RegulationChange"
  ADD CONSTRAINT "RegulationChange_sourceId_fkey"
  FOREIGN KEY ("sourceId") REFERENCES "RegulationSource"("id")
  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "RegulationChange"
  ADD CONSTRAINT "RegulationChange_snapshotId_fkey"
  FOREIGN KEY ("snapshotId") REFERENCES "RegulationDocumentSnapshot"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "RegulationAcknowledgement"
  ADD CONSTRAINT "RegulationAcknowledgement_changeId_fkey"
  FOREIGN KEY ("changeId") REFERENCES "RegulationChange"("id")
  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "RegulationAcknowledgement"
  ADD CONSTRAINT "RegulationAcknowledgement_userId_fkey"
  FOREIGN KEY ("userId") REFERENCES "User"("id")
  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "RegulationAudienceMapping"
  ADD CONSTRAINT "RegulationAudienceMapping_changeId_fkey"
  FOREIGN KEY ("changeId") REFERENCES "RegulationChange"("id")
  ON DELETE CASCADE ON UPDATE CASCADE;
