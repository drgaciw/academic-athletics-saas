...
import { z } from 'zod'
import { schedulingEngine, type ScheduledCourse, type ScheduleConstraints } from '../services/scheduling-engine'
...
routes.post(
  ...
  async (c) => {
    ...
    try {
      ...
      throw new ForbiddenError('You do not have permission to validate schedules')
    }
    ...
    const conflicts = schedulingEngine.detectConflicts(mockSchedule, constraints)
